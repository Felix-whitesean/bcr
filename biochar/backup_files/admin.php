        ...
        <?php
            if(isset($_POST['add'])){
                ...
                if (mysqli_query($con, $sql)) {
                    ?>
                    <script>
                        alert('New member Added, you can add another user below');
                    </script>
            ...
            $sql2 = "SELECT memberId, firstname, lastname, title, joined_at, userprofile, email, linkedIn, gender, whatsapp FROM members";
                        ...
                        <div class="table">
                            ...
                            while($row = mysqli_fetch_assoc($result)) {
                                ...
                                <div class="tr">
                                    ...
                                    <div style="cursor: pointer;"><a style="color: rgb(250, 50, 50);" href="delete.php?id=<?php echo "$row[memberId]";?>"><i class="fa-solid fa-user-minus"></i> Remove <?php echo($row['firstname']);?></a></div>
