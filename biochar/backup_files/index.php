...
<body>
    <div class="loadingBackground">
        ...
        <div class="constant"><img src="logo5.jpg" alt="LOADING"></div>
    </div>
    <div class="bodycontent">
        ...
        <div class="landing">
            <div class="landingContent">
                ...
                <p>Biochar Climate Resolution (BCR), a Kenyan-based company, addresses the climate crisis by focusing on Net-Zero planning and rapid carbon dioxide removal (CDR) to meet world's climate goals by 2050. BCR emphasizes the urgent need to curb greenhouse gas emissions and simultaneously remove carbon at scale, creating a carbon-negative society. The company operates in the biochar industry, producing products with the potential to sequester CO2 for centuries. BCR's efforts extend beyond being a carbon sink, recognizing nature's multifaceted functions essential for life on Earth. By deploying biochar products, BCR aims to store CO2 for extended periods, contributing to a net-negative emissions world. The company is actively involved in reducing short-lived climate pollutants, such as methane and black carbon, addressing both climate change and air pollution. BCR's overarching philosophy is to minimize human interference in the climate system while catalyzing sustainable solutions for a resilient and climate-responsible future in Kenya.</p>
            </div>
        </div>
        <hr>
        <div class="functions">
            ...
            <div class="functionsContent">
                <div class="function1">
                    ...
                    <div class="function1Text">
                        Green vegetation types can be utilized to produce biochar, a carbon-rich material obtained through the process of pyrolysis.<br><br> Pyrolysis involves heating biomass in the absence of oxygen, converting it into biochar while also producing bioenergy.
                    </div>
                ...
                <div class="function2">
                    ...
                    This shows resultant biochar products made of weeds and prunings that can be used as organic manure. It acts as a stable carbon source, enhancing soil structure, nutrient retention, and microbial activity.<br><br> Compacting this biochar into pellets increases convenience for application. These pellets can be spread across the soil surface as shown in the next frame.
                    </div>
                </div>
