            ...
            <div class="container">
                ...
                <div class="details">
                    <form action="" method="POST">
                        ...
                        <label>
                            Whatsapp no:
                            <input type="tel" name="whatsapp" pattern="\+\d{3}\d{9}" min="13" max="13" value ="<?php echo($row['whatsapp']);?>" required>
                        </label>
                        
                        <label>
                            LinkedIn url:
                            <input type="url" name="linkedIn" value ="<?php echo ($row['linkedIn']);?>" required>
                        </label>
